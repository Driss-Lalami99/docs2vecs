...
def test_faiss_vector_store_skill() -> None:
    db_path = Path("C:\\Users\\dlalami\\Documents\\docs2vec_ressources\\faissdb_test\\my_index_test.faiss")
    files_path = Path("C:\\Users\\dlalami\\Documents\\MS teams credentials IT change mana.txt")
    number_of_chunks = 1
